...
import sys
sys.path.insert(0, '/home/sung/pysot')
import os
import argparse
...
w = 0
h = 0
cap = cv2.VideoCapture("banana_deblur.mp4")
...
def detect_img():
    ...
    while 1:
      ...
      color_img = cv2.resize(frame.copy(),(1280,720),interpolation=cv2.INTER_CUBIC)
